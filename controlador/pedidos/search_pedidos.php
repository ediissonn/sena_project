    ...
    <div class="modal-dialog">
        ...
        <form id="updateOrder">
            <div class="modal-body">
                ...
                <input type="hidden" name="idpedidos_pedidos" id="idcliente_cliente" />
...
<!-- Order Table -->
        ...
        <table id="myTableOrder" class="table table-bordered table-striped border-secondary">
                <thead>
                    ...
                    <tbody>
                        ...
                        $search = $_POST['search'];
                        $query = "SELECT * FROM pedidos WHERE idpedidos_pedidos LIKE '%$search%' OR nombre_pedidos LIKE '%$search%' OR direccion_pedidos LIKE '%$search%' OR fecha_pedidos LIKE '%$search%' OR estado_pedidos LIKE '%$search%' OR idcliente_cliente LIKE '%$search%' OR idvendedor_vendedor LIKE '%$search%'";
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $customer)
                            {
                                ?>
                                <tr>
                                    <td><?= $customer['idpedidos_pedidos']; ?></td>
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="../../vistas/pedidos.php" class="btn btn-dark btn-outline-secondary me-md-2" type="button">Regresar</a>
    </div>                        
