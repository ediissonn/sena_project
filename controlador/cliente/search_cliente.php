...
<!-- Customer Table -->
    ...
    <div class="p-2">
        <table id="myTableCustomer" class="table table-bordered table-striped border-danger">
                <thead>
                        <tr>
                            <th class="bg-danger">Número de Identificación</th>
                    ...
                    <tbody>
                        ...
                        $search = $_POST['search'];
                        $query = "SELECT * FROM cliente WHERE idcliente_cliente LIKE '%$search%' OR nombre_cliente LIKE '%$search%' OR apellido_cliente LIKE '%$search%' OR telefono_cliente LIKE '%$search%' OR direccion_cliente LIKE '%$search%'";
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="../../vistas/cliente.php" class="btn btn-dark btn-outline-danger me-md-2" type="button">Regresar</a>
    </div>
