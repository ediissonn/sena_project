...
<!-- Category Table -->
    ...
    <div class="p-2">
        <table id="myTableCategory" class="table table-bordered table-striped border-warning">
                <thead>
                        <tr>
                            <th class="bg-warning">Número de Identificación</th>
                    ...
                    <tbody>
                        ...
                        $search = $_POST['search'];
                        $query = "SELECT * FROM categoria WHERE idcategoria_categoria LIKE '%$search%' OR nombre_categoria LIKE '%$search%'";
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="../../vistas/categoria.php" class="btn btn-dark btn-outline-warning me-md-2" type="button">Regresar</a>
    </div>                        
