...
<!-- Products Table -->
        ...
        <table id="myTableProduct" class="table table-bordered table-striped border-light">
                <thead>
                    ...
                    <tbody>
                        ...
                        $search = $_POST['search'];
                        $query = "SELECT * FROM producto WHERE idproducto_producto LIKE '%$search%' OR nombre_producto LIKE '%$search%' OR codigo_producto LIKE '%$search%' OR precio_unitario_producto LIKE '%$search%' OR descripcion_producto LIKE '%$search%' OR idcategoria_categoria LIKE '%$search%' OR 	idproveedor_proveedor LIKE '%$search%'";
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="../../vistas/producto.php" class="btn-back btn btn-light btn-outline-light me-md-2" type="button">Regresar</a>
    </div>                        
