...
<!-- Search Supplier Button -->
    ...
    <form action="../controlador/proveedor/search_proveedor.php" method="POST" class="d-flex form-search">
...
<!-- Supplier Table -->
    ...
    <div class="p-2">
        <table id="myTableSupplier" class="table table-bordered table-striped border-info">
                <thead>
                        <tr>
                            <th scope="col" class="bg-info">Número de Identificación</th>
                    ...
                    <tbody>
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $customer)
                            {
                                ?>
                                <tr>
                                    <td scope="row"><?= $customer['idproveedor_proveedor']; ?></td>
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="../includes/x_index.php" class="btn btn-dark btn-outline-info me-md-2" type="button">Regresar</a>
    </div>                        
