...
<!-- Create Seller Button -->   
    ...
    <button type="button" class="btn-new btn btn-success" data-bs-toggle="modal" data-bs-target="#sellerAddModal">
        Crear Vendedor
    </button>

<!-- Search Seller Button -->
    
    <form action="../controlador/vendedor/search_vendedor.php" method="POST" class="d-flex form-search">
...
<!-- Sellers Table -->
    ...
    <div class="p-2">
        <table id="myTableSeller" class="table table-bordered table-striped border-success">
                <thead>
                        <tr>
                            <th scope="col" class="bg-success">Número de Identificación</th>
                            <th scope="col" class="bg-success">Nombre</th>
                            <th scope="col" class="bg-success">Apellido</th>
                            <th scope="col" class="bg-success">Direccion</th>
                            <th scope="col" class="bg-success">Telefono</th>
                    ...
                    <tbody>
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $customer)
                            {
                                ?>
                                <tr>
                                    <td scope="row"><?= $customer['idvendedor_vendedor']; ?></td>
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="../includes/x_index.php" class="btn btn-dark btn-outline-success me-md-2" type="button">Regresar</a>
    </div>                        
